...
public class AProductAdapter extends RecyclerView.Adapter<AProductAdapter.ViewHolder> {

    private ArrayList<AProduct> items;

    public AProductAdapter (Context context, ArrayList<AProduct> List)
    {
        items = List;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull AProductAdapter.ViewHolder viewHolder, int i) {
        ...
        {
            viewHolder.prod.setImageResource(R.drawable.arms);
        }
        else
        {
